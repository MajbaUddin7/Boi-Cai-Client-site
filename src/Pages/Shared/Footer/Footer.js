    ...
    return (
        <footer className="text-white bg-gray-800 body-font">
            ...
            <div>
                ...
                <div className="w-10/12 py-8 flex flex-wrap mx-auto items-center">
                    <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
                        <div className="relative sm:w-64 w-40 sm:mr-4 mr-2">
                            {/* <label for="footer-field" className="leading-7 text-sm text-white">Placeholder</label> */}
                            <input type="text" id="footer-field" name="footer-field" className="w-full bg-white-100 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:bg-transparent focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder='Enter your email' />
                        </div>
                        <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Subscribe Us</button>
